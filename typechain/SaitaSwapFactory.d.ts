...
interface SaitaSwapFactoryInterface extends ethers.utils.Interface {
  functions: {
...
export type SetFeeToEvent = TypedEvent<[string] & { _feeTo: string }>;

export type SetFeeToSetterEvent = TypedEvent<
  [string] & { _feeToSetter: string }
>;

export class SaitaSwapFactory extends BaseContract {
  ...
  interface: SaitaSwapFactoryInterface;
  ...
  filters: {
    ...
    "SetFeeTo(address)"(
      _feeTo?: null
    ): TypedEventFilter<[string], { _feeTo: string }>;

    SetFeeTo(_feeTo?: null): TypedEventFilter<[string], { _feeTo: string }>;

    "SetFeeToSetter(address)"(
      _feeToSetter?: null
    ): TypedEventFilter<[string], { _feeToSetter: string }>;
